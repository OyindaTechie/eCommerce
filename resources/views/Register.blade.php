...
<div class="container">
  <h2 class="text-center">Shopping App Registration | Add</h2>
  <br>
  ...
  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"><input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
    ...
    <input type="text" class="form-control" placeholder="Your Name" name="firstname_lastname">
    
  <label>Phone Number</label>
  <input type="text" class="form-control" placeholder="Your phone number" name="phone_number">
